...
\hfill \\ \hfill
\normal{\input{barneys/1_estructura.tex}}

\hfill \\ \hfill
{\medium{Oración Inicial}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{barneys/2_oracion_inicial.tex}}

\hfill \\ \hfill
{\medium{Motivación al Evangelio}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{barneys/3_motivacion.tex}}

\newpage
{\noindent \medium{Evangelio}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{barneys/4_evangelio.tex}}

\hfill \\ \hfill
{\medium{Actividades}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{barneys/5_actividades.tex}}

\hfill \\ \hfill
{\medium{Propósito Comunitario}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{barneys/6_proposito.tex}}

\hfill \\ \hfill
{\medium{Oración Final}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{barneys/7_oracion_final.tex}}
...
\end{center}
% \hfill \\ \hfill
\normal{\input{barneys/8_anexos.tex}}
...
\def\lunes{Lc 15, 45-50\\} % Lo que va el día lunes
\def\martes{Lc 16, 1-5\\} % Lo que va el día martes
\def\miercoles{Lc 16, 6-13\\} % Lo que va el día miércoles
\def\jueves{Lc 16, 14-25\\} % Lo que va el día jueves
\def\viernes{Lc 16, 26-33\\} % Lo que va el día viernes
\def\sabado{Lc 17, 1-10\\} % Lo que va el día sábado
\def\domingo{Lc 17, 11-21\\} % Lo que va el día domingo

\hfill \\ \hfill
{\medium{Esta semana}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{barneys/9_calendario.tex}}
  ...
  execute before day scope=
  {
    \ifdate{workday}
    {
      ...
      \draw (0,0)node [shape=rectangle, minimum height= .53cm,
        ...
        {\fontsize{12}{15}\selectfont\negritafont\pgfcalendarweekdayshortname{\pgfcalendarcurrentweekday}};
    }{}
    \ifdate{Saturday}{
      % Shift right
      \pgftransformxshift{2.6cm}
