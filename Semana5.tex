...
\hfill \\ \hfill
\normal{\input{Semana5/1_estructura.tex}}

\hfill \\ \hfill
{\medium{Oración Inicial}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{Semana5/2_oracion_inicial.tex}}

\hfill \\ \hfill
{\medium{Motivación al Evangelio}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{Semana5/3_motivacion.tex}}

\newpage
{\noindent \medium{Evangelio}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{Semana5/4_evangelio.tex}}

\hfill \\ \hfill
{\medium{Actividades}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{Semana5/5_actividades.tex}}

\hfill \\ \hfill
{\medium{Propósito Comunitario}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{Semana5/6_proposito.tex}}

\hfill \\ \hfill
{\medium{Oración Final}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{Semana5/7_oracion_final.tex}}
...
\end{center}
% \hfill \\ \hfill
\normal{\input{Semana5/8_anexos.tex}}
...
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{Semana5/9_calendario.tex}}
