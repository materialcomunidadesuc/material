...
\hfill \\ \hfill
\normal{\input{template_1/1_estructura.tex}}

\hfill \\ \hfill
{\medium{Oración Inicial}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{template_1/2_oracion_inicial.tex}}

\hfill \\ \hfill
{\medium{Motivación al Evangelio}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{template_1/3_motivacion.tex}}

\newpage
{\noindent \medium{Evangelio}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{template_1/4_evangelio.tex}}

\hfill \\ \hfill
{\medium{Actividades}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{template_1/5_actividades.tex}}

\hfill \\ \hfill
{\medium{Propósito Comunitario}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{template_1/6_proposito.tex}}

\hfill \\ \hfill
{\medium{Oración Final}}
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{template_1/7_oracion_final.tex}}
...
\end{center}
% \hfill \\ \hfill
\normal{\input{template_1/8_anexos.tex}}
...
{\color{amarillo} \vspace{4pt} \hrule height 4pt }
\hfill \\ \hfill
\normal{\input{template_1/9_calendario.tex}}
